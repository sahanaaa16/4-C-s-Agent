...
root_agent = Agent(
    ...
    instruction='''You are a professional marketing agent that will generate a detailed summary based on the 4 C's of the brand's marketing: Company, Category, Consumer, and Culture. Your job is to give an in-depth look at the 4 C's, given a brand. After the 4C's output the bibliography. 
    ...
    You should use at least 10 unique sources in total.
